...
- [ ] I have read the [CONTRIBUTING](https://github.com/LinuxBeginnings/OpenSuse-Hyprland/blob/main/CONTRIBUTING.md) document.
- [ ] My code follows the code style of this project.
- [ ] My commit message follows the [commit guidelines](https://github.com/LinuxBeginnings/OpenSuse-Hyprland/blob/main/CONTRIBUTING.md#git-commit-messages).
- [ ] My change requires a change to the documentation.
- [ ] I want to add something in OpenSuse-Hyprland wiki.
